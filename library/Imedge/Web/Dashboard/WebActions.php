    ...
    public function init()
    {
        ...
        $this->actions = [
            'vendors' => WebAction::create([
                ...
                'table'   => 'input',
                // 'listUrl' => 'inventory/configuration/vendors',
                'listUrl' => '#',
                'url'     => 'inventory/configuration/vendor',
                'icon'    => 'book',
            ]),
            'deviceModels' => WebAction::create([
                ...
                'table'   => 'input',
                // 'listUrl' => 'inventory/configuration/server-models',
                'listUrl' => '#',
                'url'     => 'inventory/configuration/server-model',
                'icon'    => 'host',
            ]),
            'rackModels' => WebAction::create([
                ...
                'table'   => 'input',
                // 'listUrl' => 'inventory/configuration/rack-models',
                'listUrl' => '#',
                'url'     => 'inventory/configuration/rack-model',
                'icon'    => 'th-list',
            ]),
            ...
            'datanodes' => WebAction::create([
                ...
                'table'   => 'input',
                'listUrl' => 'inventory/datanodes',
                'url'     => 'inventory/datanode',
                'icon'    => 'globe',
            ]),
            'snmpDevices' => WebAction::create([
                ...
                'table'   => 'snmp_agent',
                'listUrl' => 'inventory/snmp/devices',
                'url'     => 'inventory/snmp/device',
                'icon'    => 'barchart  ',
            ]),
            'networkDevices' => WebAction::create([
                ...
                // 'listUrl' => 'inventory/network-devices',
                'listUrl' => '#',
                'url'     => 'inventory/network-device',
                'icon'    => 'sitemap',
            ]),
            'radioDevices' => WebAction::create([
                ...
                // 'listUrl' => 'inventory/antennas',
                'listUrl' => '#',
                'url'     => 'inventory/antenna',
                'icon'    => 'wifi',
            ]),
            'snmpcredentials' => WebAction::create([
                ...
                'table'   => 'input',
                'listUrl' => 'inventory/snmp/credentials',
            ...
            'history' => WebAction::create([
                ...
                'table'   => 'input',
                'listUrl' => 'inventory/history/table-sync',
                // 'url'     => 'inventory/snmp/credentials',
                'icon'    => 'history',
            ]),
            'snmpDiscoveryRules' => WebAction::create([
                ...
                'listUrl' => 'inventory/discovery/rules',
                'icon'    => 'sliders',
            ]),
            'snmpDiscoveryCandidates' => WebAction::create([
                ...
                'listUrl' => 'inventory/discovery/candidates',
                'icon'    => 'eye',
            ]),
            ...
            */
            'apitokens' => WebAction::create([
                ...
                'table'   => 'api_token',
                'listUrl' => 'inventory/configuration/apitokens',
                'url'     => 'inventory/configuration/apitoken',
                'icon'    => 'lock-open-alt',
            ]),
        ];
    }
